...
if __name__ == "__main__":
    ...
    if compute:
        parameters = {
            "window_length_fraction": [1, 0.5, 0.3, 0.25, 0.20, 0.10, 0.05, 0.025, 0.01],
            "hop_fraction": [1, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1],

            "window_length_fraction": [0.01, 0.005, 0.0025, 0.001, 0.0001, 0.00001, 0.000001],
            "hop_fraction": [1, 0.9, 0.8, 0.7, 0.6, 0.5],
