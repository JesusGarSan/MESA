...
if __name__ == "__main__":
    ...
    if compute:
        parameters = {
            ...
            # "hop_fraction": [0.2, 0.1, 0.05, 0.025, 0.01],
        ...
        gc_fid_metrics = [
            ...
            "SS_time", "SS_treatment", "SS_sex", "SS_order", "SS_residuals", "SS_null",
            "F_time", "F_treatment", "F_sex", "F_order", "F_residuals", "F_null",
            "p_time", "p_treatment", "p_sex", "p_order", "p_null",
            "dist_time", "dist_treatment", "dist_sex", "dist_order", "dist_null"
        ]
    ...
    if plot:
        plot_heatmaps("external/examples/GC-FID/optimization.csv",
                    ...
                    'window_function',
                    ['p_time', 'p_treatment', 'p_sex', 'p_order', 'p_null'], vmin = 0, vmax = 0.10,
        ...
        fig = plot_heatmaps("external/examples/GC-FID/optimization.csv",
                    ...
                    'window_length_fraction',
                    'window_function',
                    ['F_time', 'F_treatment', 'F_sex', 'F_order', 'F_null'],
                    # vmin = 0, vmax = 30,
                    output_dir="external/examples/GC-FID/heatmaps/",
                    cmap = "ocean_r")
        fig = plot_heatmaps("external/examples/GC-FID/optimization.csv",
        ...
        plot_heatmaps("external/examples/GC-FID/optimization.csv",
                    ...
                    'window_length_fraction',
                    'window_function',
                    ['SS_time', 'SS_treatment', 'SS_sex', 'SS_order', 'SS_null'],
                    # vmin = 0, vmax = 30,
                    output_dir="external/examples/GC-FID/heatmaps/",
                    cmap = "ocean_r")
        plot_heatmaps("external/examples/GC-FID/optimization.csv",
